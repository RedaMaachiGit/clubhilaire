    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Ce lot numero <?php echo $numeroCoupon; ?> contient: <?php echo $articles[0]->getLibelleTypeArticle(); if(!empty($articles[1])){ echo " ET ".$articles[1]->getLibelleTypeArticle();} else {echo "";}; ?> </h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
