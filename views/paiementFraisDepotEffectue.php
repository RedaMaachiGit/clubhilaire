...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Paiement frais de dépot effectué
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../index.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="../nouveauLot.html">   Paiement frais de dépot effectué </a></li>
      </ol>
    </section>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">  Paiement frais de dépot effectué/h4>
            </div>
            <div class="modal-body">
              <p style="font-size:30px"> Paiement frais de dépot effectué </p>
            </div>
