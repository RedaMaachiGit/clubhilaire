...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Vente d'un ensemble de lots
        <small>Vous êtes sur le point de vendre un ensemble de lots</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <?php
        ...
        foreach ($lots as $key => $lot) {
          ...
          $prixLotCumule = $prixLotCumule + $lot->getPrix();
          $prixLot = $lot->getPrix();
          $numeroCoupon = $lot->getCouponNoIncr();
          array_push($coupons, $numeroCoupon);
      ...
      <?php if($nombreArticles==0){ ?>
        <div class="alert alert-danger fade in">
            ...
            <strong>ATTENTION!</strong> Le lot numéro <?php echo $numeroCoupon ?> ne possède pas de produits ajoutez en d'abords.
        </div>
      <?php } ?>
      <div class="box">
      ...
      <div class="box box-info">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Prix des lots</span>
            <span class="info-box-number" style="font-size:30px"><?php echo $prixLotCumule ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
        ...
        <form id="paiementForm" class="form-horizontal" method="POST" action="../controller/paiementController.php" class="form-horizontal" onsubmit="return validateForm()">
          <div class="box-body">
            ...
            foreach($coupons as $coupon) {
                echo '<input type="hidden" name="lots[]" value="'. $coupon. '">';
            }
            ?>
            <input type="text" class="hidden" id="venteLotsMultiple" name="venteLotsMultiple" value="venteLotsMultiple" />
...
function validateForm() {
  ...
  var prixDuLot = "<?php echo $prixLotCumule ?>";
  if(index == 0){
