...
<head>
  ...
  <title>Reduction vendeur pro</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        <form id="formulaireAjoutReduction" class="form-horizontal" method="POST" action="../controller/controllerReduction.php" class="form-horizontal">
          <div class="box-body">
            <div class="col-xs-12">
              <div class="row">
                <div class="col-xs-12">
