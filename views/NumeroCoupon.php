...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Affectation du numéro de coupon pour les lots suivants <?php echo $_GET['numeroLot'] ?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p style="font-size:30px">Votre numéro de coupon: <?php echo $_GET['coupon'] ?></p>
            </div>
            <div class="modal-footer">
              <!-- <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button> -->
              <a href:"../index.html"><button type="button" class="btn btn-primary">J'ai retenu</button></a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
